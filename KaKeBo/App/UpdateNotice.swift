...
private struct UpdateNoticeContent: View {
    ...
    static let defaultHighlights: [Highlight] = [
        .init(title: "大きいウィジェットの内容が見やすく", message: "ホーム画面の最大サイズのウィジェットがひと回り小さくなり、表示が画面内に収まるようになりました。", symbol: "rectangle.and.arrow.down.right.and.arrow.up.left", tint: .blue),
