...
private struct UpdateNoticeContent: View {
    ...
    static let defaultHighlights: [Highlight] = [
        .init(title: "共有招待がうまくいかないときに再試行ボタンを表示", message: "ネットワークの混雑などで招待が失敗した場合でも、その場で再試行できるようになりました。招待リンクを開いても進まないときの手がかりを詳しく表示します。", symbol: "arrow.triangle.2.circlepath", tint: .orange),
